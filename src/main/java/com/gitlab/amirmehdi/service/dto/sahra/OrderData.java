...
public class OrderData {
    ...
    public OrderData(ArrayList<Object> s) {
        this(String.valueOf(((Number) s.get(0)).longValue())
            ...
            , (String) s.get(11), (Boolean) s.get(12)
            , OrderLockType.get(((Number) s.get(13)).intValue())
            , ((Number) s.get(14)).intValue(), ((Number) s.get(15)).intValue()
            , (Boolean) s.get(16)
            , ((Number) s.get(17)).longValue(), ((Number) s.get(18)).intValue()
            , (String) s.get(19)
            , OrderSource.get(((Number) s.get(20)).intValue())
            , (String) s.get(21)
        );
    }
}
