...
public class OptionResourceIT {
    ...
    @Test
    @Transactional
    public void checkCallBreakEvenIsRequired() throws Exception {
        int databaseSizeBeforeTest = optionRepository.findAll().size();
        // set the field null
        option.setCallBreakEven(null);
    ...
    @Test
    @Transactional
    public void checkPutBreakEvenIsRequired() throws Exception {
        int databaseSizeBeforeTest = optionRepository.findAll().size();
        // set the field null
        option.setPutBreakEven(null);
    ...
    @Test
    @Transactional
    public void checkCallAskToBSIsRequired() throws Exception {
        int databaseSizeBeforeTest = optionRepository.findAll().size();
        // set the field null
        option.setCallAskToBS(null);
    ...
    @Test
    @Transactional
    public void checkPutAskToBSIsRequired() throws Exception {
        int databaseSizeBeforeTest = optionRepository.findAll().size();
        // set the field null
        option.setPutAskToBS(null);
